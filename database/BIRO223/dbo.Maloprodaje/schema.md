...
| 2 | `Centralno` | `smallint` | Yes | No | No | `` |  |
| 3 | `DatumVnosa` | `nvarchar(12)` | Yes | No | No | `` |  |
| 4 | `Komentar` | `nvarchar(50)` | Yes | No | No | `` |  |
| 5 | `MPCeneRazlicno` | `smallint` | Yes | No | No | `` |  |
...
| 12 | `Vrsta` | `nvarchar(50)` | Yes | No | No | `` |  |
| 13 | `ZunanjaBlagajna` | `smallint` | Yes | No | No | `` |  |
