# `dbo`.`DobavniceIzdajaOtvoritveSpecifikacija`
...
| 8 | `Narocilo` | `nvarchar(6)` | Yes | No | No | `` |  |
| 9 | `Rabat` | `decimal(12,6)` | Yes | No | No | `` |  |
| 10 | `RecNo` | `int` | No | Yes | No | `` |  |
| 11 | `SifraDavka` | `nvarchar(2)` | Yes | No | No | `` |  |
| 12 | `Stevilka` | `nvarchar(10)` | Yes | No | No | `` |  |
| 13 | `Ura` | `nvarchar(10)` | Yes | No | No | `` |  |
| 14 | `Zaporedje` | `smallint` | Yes | No | No | `` |  |
