...
| 6 | `NabavnaCena` | `float` | Yes | No | No | `` |  |
| 7 | `ProdajnaCenaObNabavi` | `float` | Yes | No | No | `` |  |
| 8 | `ProdajniDavekObNabavi` | `float` | Yes | No | No | `` |  |
| 9 | `ProdajniSifraDavkaObNabavi` | `nvarchar(5)` | Yes | No | No | `` |  |
