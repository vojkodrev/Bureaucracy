...
| 9 | `NacinNakazila` | `smallint` | Yes | No | No | `` |  |
| 10 | `NamenNakazila1` | `nvarchar(40)` | Yes | No | No | `` |  |
| 11 | `NamenNakazila2` | `nvarchar(40)` | Yes | No | No | `` |  |
| 12 | `NeUpostevajZaDDV` | `smallint` | Yes | No | No | `` |  |
| 13 | `ObracunDDV` | `smallint` | Yes | No | No | `` |  |
| 14 | `Opombe` | `ntext` | Yes | No | No | `` |  |
