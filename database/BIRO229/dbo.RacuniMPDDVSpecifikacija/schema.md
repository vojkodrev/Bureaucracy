...
| 5 | `Dobavnica` | `nvarchar(6)` | Yes | No | No | `` |  |
...
| 13 | `RabatSIT` | `float` | Yes | No | No | `` |  |
| 14 | `RecNo` | `int` | No | Yes | No | `` |  |
| 15 | `SifraDavka` | `nvarchar(2)` | Yes | No | No | `` |  |
| 16 | `SpremniText` | `ntext` | Yes | No | No | `` |  |
| 17 | `Stevilka` | `nvarchar(10)` | Yes | No | No | `` |  |
| 18 | `Ura` | `smallint` | Yes | No | No | `` |  |
| 19 | `Zaporedje` | `smallint` | Yes | No | No | `` |  |
| 20 | `Znesek` | `float` | Yes | No | No | `` |  |
| 21 | `ZnesekBrezDavka` | `float` | Yes | No | No | `` |  |
