...
| 19 | `RabatSIT` | `float` | Yes | No | No | `` |  |
| 20 | `RecNo` | `int` | No | Yes | No | `` |  |
| 21 | `SifraDavka` | `nvarchar(2)` | Yes | No | No | `` |  |
| 22 | `SpremniText` | `ntext` | Yes | No | No | `` |  |
| 23 | `Stevilka` | `nvarchar(10)` | Yes | No | No | `` |  |
| 24 | `Ura` | `smallint` | Yes | No | No | `` |  |
| 25 | `Zaporedje` | `smallint` | Yes | No | No | `` |  |
| 26 | `Znesek` | `float` | Yes | No | No | `` |  |
| 27 | `ZnesekBrezDavka` | `float` | Yes | No | No | `` |  |
