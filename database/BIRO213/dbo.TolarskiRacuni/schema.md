...
| 7 | `Sklic1` | `nvarchar(2)` | Yes | No | No | `` |  |
| 8 | `Sklic2` | `nvarchar(50)` | Yes | No | No | `` |  |
| 9 | `StevilkaRacuna` | `nvarchar(25)` | Yes | No | No | `` |  |
| 10 | `Valuta` | `nvarchar(10)` | Yes | No | No | `` |  |
| 11 | `Vnasalec` | `nvarchar(20)` | Yes | No | No | `` |  |
| 12 | `VrstaRacuna` | `smallint` | Yes | No | No | `` |  |
| 13 | `ZR` | `nvarchar(60)` | Yes | No | No | `` |  |
