...
| 13 | `ImeStevilke` | `nvarchar(15)` | Yes | No | No | `` |  |
| 14 | `Izvor` | `nvarchar(20)` | Yes | No | No | `` |  |
| 15 | `KONTO` | `nvarchar(10)` | Yes | No | No | `` |  |
| 16 | `MDL1` | `nvarchar(30)` | Yes | No | No | `` |  |
| 17 | `MDL2` | `nvarchar(20)` | Yes | No | No | `` |  |
| 18 | `NacinPlacila` | `smallint` | Yes | No | No | `` |  |
| 19 | `NeUpostevaj` | `smallint` | Yes | No | No | `` |  |
| 20 | `OE` | `nvarchar(30)` | Yes | No | No | `` |  |
| 21 | `OznakaValute` | `nvarchar(3)` | Yes | No | No | `` |  |
| 22 | `PARTNER` | `nvarchar(10)` | Yes | No | No | `` |  |
| 23 | `PKONTO` | `nvarchar(10)` | Yes | No | No | `` |  |
| 24 | `RecNo` | `int` | No | Yes | No | `` |  |
| 25 | `StatusDDV` | `smallint` | Yes | No | No | `` |  |
| 26 | `STEV_DOK` | `nvarchar(20)` | Yes | No | No | `` |  |
| 27 | `Stevilka` | `nvarchar(10)` | Yes | No | No | `` |  |
| 28 | `TabelaIzvora` | `nvarchar(20)` | Yes | No | No | `` |  |
| 29 | `TecajVALUTE` | `float` | Yes | No | No | `` |  |
| 30 | `Temeljnica` | `smallint` | Yes | No | No | `` |  |
| 31 | `TempZapis` | `float` | Yes | No | No | `` |  |
| 32 | `Urejenost` | `smallint` | Yes | No | No | `` |  |
| 33 | `Vnasalec` | `nvarchar(20)` | Yes | No | No | `` |  |
| 34 | `VrstaDokumenta` | `nvarchar(10)` | Yes | No | No | `` |  |
| 35 | `VrstaTemeljnice` | `smallint` | Yes | No | No | `` |  |
| 36 | `ZAPIS` | `float` | Yes | No | No | `` |  |
