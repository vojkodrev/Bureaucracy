...
| 12 | `NadaljnaProdaja` | `smallint` | Yes | No | No | `` |  |
...
| 27 | `Skladisce` | `nvarchar(5)` | Yes | No | No | `` |  |
...
| 32 | `StevilkaPlacila` | `smallint` | Yes | No | No | `` |  |
| 33 | `StevilkaZaprtegaPlacila` | `nvarchar(10)` | Yes | No | No | `` |  |
...
| 41 | `Zaokrozevanje` | `float` | Yes | No | No | `` |  |
| 42 | `ZiroRacun` | `nvarchar(60)` | Yes | No | No | `` |  |
| 43 | `Znesek` | `float` | Yes | No | No | `` |  |
| 44 | `ZnesekDDV` | `float` | Yes | No | No | `` |  |
