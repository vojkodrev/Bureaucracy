# `dbo`.`RacuniOtvoritveSpecifikacija`
...
| 7 | `MPO` | `nvarchar(50)` | Yes | No | No | `` |  |
| 8 | `NabavnaCena` | `float` | Yes | No | No | `` |  |
| 9 | `NeUpostevajZaDDV` | `smallint` | Yes | No | No | `` |  |
| 10 | `OznakaLeta` | `nvarchar(2)` | Yes | No | No | `` |  |
| 11 | `PE` | `nvarchar(50)` | Yes | No | No | `` |  |
| 12 | `Rabat` | `float` | Yes | No | No | `` |  |
...
| 18 | `ZnesekBrezDavka` | `float` | Yes | No | No | `` |  |
