            ...
            <CardContent>
                <Table>
                    ...
                    <TableBody>
                        ...
                        <TableRow><TableCell>Paid amount</TableCell><TableCell><NumberInput aria-label="Paid amount" min="0" step="0.01" value={paidAmount} onChange={(event) => onPaidAmountChange(event.target.value)} className="ml-auto text-right" /></TableCell></TableRow>
