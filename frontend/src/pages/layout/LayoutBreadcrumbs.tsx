...
function getBreadcrumbContext(pathname: string): BreadcrumbContext {
    const entities = [
        ...
        {
            prefix: "/price-quote/",
            editPath: "/price-quote",
            editLabel: "Price quote",
            searchPath: "/price-quotes/search",
            searchLabel: "Price quote search",
        },
        {
            prefix: "/product/",
            editPath: "/product",
        ...
        },
        {
            ...
            editPath: "/inventory-item",
            editLabel: "Inventory item",
            searchPath: "/inventory-items/search",
            searchLabel: "Inventory item search",
        },
        {
            prefix: "/customer/",
            editPath: "/customer",
        ...
        },
        {
            ...
            editPath: "/bank-statement",
            editLabel: "Bank statement",
            searchPath: "/bank-statements/search",
            searchLabel: "Bank statement search",
        },
    ];
            ...
            <BreadcrumbList>
                {entity ? (
                    <>
                        <BreadcrumbItem>
                            <BreadcrumbLink
                                render={<NavLink to={entity.searchPath} />}
                            >
                                {entity.searchLabel}
                            </BreadcrumbLink>
                        </BreadcrumbItem>
                        ...
                        <BreadcrumbItem>
                            {entity.value ? (
                                <BreadcrumbLink
                                    render={<NavLink to={entity.editPath} />}
                                >
                                    {entity.editLabel}
                                </BreadcrumbLink>
                            ) : (
                    ...
                    <BreadcrumbItem>
                        <BreadcrumbPage>{context.label}</BreadcrumbPage>
                    </BreadcrumbItem>
                )}
            </BreadcrumbList>
        </Breadcrumb>
